...
- Guru wali kelas.
- Admin sekolah.
- Dinas Pendidikan Provinsi, terutama jika aplikasi digunakan lintas SMA/SMK dalam satu provinsi.
- Siswa sebagai peserta didik yang menerima tugas, quiz, exam, informasi nilai, absensi, mading, dan spotlight karya.
- Orang tua siswa.
...
| Dashboard siswa | Memberi siswa satu tempat untuk melihat aktivitas belajar yang perlu dikerjakan. |
| Tugas siswa | Membantu siswa melihat instruksi tugas dan mengirim jawaban tanpa menunggu pembagian manual. |
| Quiz siswa | Membantu siswa mengikuti evaluasi harian secara digital dan melihat status pengerjaan sesuai aturan guru. |
| Exam siswa | Membantu siswa mengikuti ujian terjadwal dengan alur yang lebih tertib. |
| Nilai siswa | Membantu siswa memantau hasil belajar yang sudah tersedia tanpa harus menunggu rekap manual. |
| Absensi siswa | Membantu siswa mengetahui catatan kehadiran yang tercatat di kelas. |
| Mading siswa | Memberi ruang publikasi karya/tulisan siswa dalam lingkungan aplikasi. |
| Spotlight siswa | Memberi ruang apresiasi karya gambar atau video pendek siswa melalui proses review. |
...
- Siswa mengumpulkan tugas melalui pesan pribadi atau file tercecer di luar sistem.
- Siswa menanyakan ulang daftar tugas, jadwal quiz, nilai, atau absensi karena tidak ada portal ringkas.
- Publikasi karya siswa dilakukan secara manual tanpa alur review digital.
...
- Tidak hanya membantu guru membuat dokumen, tetapi juga menyediakan portal siswa agar hasil kerja guru tersambung ke aktivitas belajar.
- Siswa dapat memiliki ruang belajar digital untuk melihat tugas, quiz, exam, nilai, absensi, mading, dan spotlight dari satu akun.
- Karya siswa tidak hanya disimpan di luar sistem; mading dan spotlight memberi jalur apresiasi yang lebih terarah.
...
## 10A. Manfaat untuk Dinas Pendidikan Provinsi

Bagian ini menggunakan asumsi: semua SMA dan SMK se-provinsi menggunakan GuruSpace. Dalam konteks tersebut, GuruSpace dapat memberi manfaat pada level dinas sebagai platform monitoring proses pembelajaran berbasis data.

- Monitoring administrasi pembelajaran lebih terpusat, terutama kesiapan dokumen ajar, jurnal, absensi, tugas, quiz, exam, dan penilaian.
- Pemetaan aktivitas pembelajaran lintas sekolah, kabupaten/kota, mata pelajaran, kelas, dan jenjang SMA/SMK.
- Pengurangan laporan manual berulang dari sekolah karena sebagian data operasional sudah tersedia di sistem.
- Dasar pengambilan kebijakan berbasis data aktivitas sekolah, bukan hanya laporan naratif.
- Pemantauan implementasi kurikulum melalui dokumen seperti ATP, Modul Ajar/RPP, PROTA, PROMES, asesmen, dan tindak lanjut nilai.
- Identifikasi sekolah atau wilayah yang membutuhkan pendampingan berdasarkan aktivitas rendah, dokumen belum lengkap, absensi tidak tertib, atau evaluasi yang jarang dilakukan.
- Efisiensi supervisi dan pembinaan karena pengawas atau tim dinas dapat meninjau data awal sebelum kunjungan lapangan.
- Standarisasi alur administrasi guru se-provinsi tanpa menghilangkan fleksibilitas isi sesuai sekolah, mapel, kelas, dan program keahlian.
- Pengendalian pemanfaatan AI di sekolah melalui sistem kredit, quota, provider, dan tracking biaya.
- Potensi transparansi aktivitas belajar jika portal siswa dan orang tua digunakan secara konsisten.

Catatan kejujuran: manfaat level dinas membutuhkan dashboard agregat provinsi/kabupaten/kota yang belum dicatat sebagai role final di matriks saat ini. Materi presentasi boleh menyebutnya sebagai potensi pengembangan strategis atau arah manfaat jika adopsi sudah luas.
...
- Siswa lebih cepat mengetahui tugas, quiz, exam, nilai, dan absensi yang tersedia dari portalnya.
- Guru tidak perlu berulang kali menjawab pertanyaan dasar siswa tentang aktivitas yang sudah tercatat di sistem.
...
- Pengumpulan tugas dan aktivitas digital mengurangi kebutuhan cetak, fotokopi, atau distribusi file manual untuk sebagian workflow.
...
- Siswa mendapat pengalaman belajar yang lebih tertib karena tugas, quiz, exam, nilai, dan absensi berada dalam ruang yang sama.
- Guru dan siswa memiliki jejak aktivitas yang lebih mudah dilihat kembali dibanding komunikasi tersebar di chat atau file terpisah.
